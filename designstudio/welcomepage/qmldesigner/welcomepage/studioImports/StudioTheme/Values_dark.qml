...
QtObject {
    ...
    property string themePanelBackground: "#323232" //"#242424"Theme.color(Theme.DSpanelBackground)
    property string welcomeScreenBackground: "#242424" //NEW COLOR _ NEEDS ADDING TO THEME
    property string themeSubPanelBackground: "#1C1C1C"//NEW COLOR _ NEEDS ADDING TO THEME
    property string themeThumbnailBackground: "#232323"//NEW COLOR _ NEEDS ADDING TO THEME
    property string themeThumbnailLabelBackground: "#2B2A2A"//NEW COLOR _ NEEDS ADDING TO THEME
    ...
    // Control colors
    property string themeControlBackground: "#2B2A2A"//Theme.color(Theme.DScontrolBackground)
    property string themeControlBackgroundInteraction: "#333333"//"#595959"Theme.color(Theme.DScontrolBackgroundInteraction)
    property string themeControlBackgroundDisabled: values.themePanelBackground//Theme.color(Theme.DScontrolBackgroundDisabled)
    property string themeControlBackgroundGlobalHover: "#2B2A2A"
    property string themeControlBackgroundHover: "#333333" //"#666666"

    property string themeControlOutline: "#1f1f1f"//Theme.color(Theme.DScontrolOutline)
    ...
    // Text colors
    property string themeTextColor: "#ffffff"//Theme.color(Theme.DStextColor)
    ...
    // Icon colors
    property string themeIconColor: "#ffffff"
    property string themeIconColorHover: "#262626"
    property string themeIconColorInteraction: "#262626" // press
    ...
    property string themeLinkIndicatorColorHover: "white"
    ...
    property string themePopupBackground: "#474747"
    ...
    property string themeSliderInactiveTrack: "#595959"//Theme.color(Theme.DSsliderInactiveTrack)
    ...
    property string themeSliderHandle: "#505050"//Theme.color(Theme.DSsliderHandle)
    ...
    property string themeScrollBarTrack: "#404040"//Theme.color(Theme.DSscrollBarTrack)
    property string themeScrollBarHandle: "#505050"//Theme.color(Theme.DSscrollBarHandle)

    property string themeSectionHeadBackground: "#191919"//Theme.color(Theme.DSsectionHeadBackground)
