...
Row {
    ...
    ActionIndicator {
        ...
        x: 0
        y: 0
        // + spacing on width because of negative spacing on the row
        width: actionIndicator.visible ? myButtonRow.__actionIndicatorWidth + myButtonRow.spacing : 0
