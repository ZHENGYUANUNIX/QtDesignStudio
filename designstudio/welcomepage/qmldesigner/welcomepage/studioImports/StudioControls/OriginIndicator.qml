...
Item {
    ...
    states: [
        State {
            name: "center"
            when: root.myControl.origin === Item.Center
            PropertyChanges {
                target: indicator
        ...
        State {
            name: "topLeft"
            when: root.myControl.origin === Item.TopLeft
            PropertyChanges {
                target: indicator
        ...
        State {
            name: "top"
            when: root.myControl.origin === Item.Top
            PropertyChanges {
                target: indicator
                x: StudioTheme.Values.border + root.iWidth
                y: StudioTheme.Values.border
        ...
        State {
            name: "topRight"
            when: root.myControl.origin === Item.TopRight
            PropertyChanges {
                target: indicator
        ...
        State {
            name: "right"
            when: root.myControl.origin === Item.Right
            PropertyChanges {
                target: indicator
                x: StudioTheme.Values.border + (2 * root.iWidth)
                y: StudioTheme.Values.border + root.iHeight
        ...
        State {
            name: "bottomRight"
            when: root.myControl.origin === Item.BottomRight
            PropertyChanges {
                target: indicator
                x: StudioTheme.Values.border + (2 * root.iWidth)
        ...
        State {
            name: "bottom"
            when: root.myControl.origin === Item.Bottom
            PropertyChanges {
                target: indicator
                x: StudioTheme.Values.border + root.iWidth
                y: StudioTheme.Values.border + (2 * root.iHeight)
        ...
        State {
            name: "bottomLeft"
            when: root.myControl.origin === Item.BottomLeft
            PropertyChanges {
                target: indicator
                x: StudioTheme.Values.border
                y: StudioTheme.Values.border + (2 * root.iHeight)
        ...
        State {
            name: "left"
            when: root.myControl.origin === Item.Left
            PropertyChanges {
                target: indicator
                x: StudioTheme.Values.border
                y: StudioTheme.Values.border + root.iHeight
